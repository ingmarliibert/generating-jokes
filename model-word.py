...
dump(tokenizer, open('tokenizer-word.pkl', 'wb'))
...
checkpoint = ModelCheckpoint("model-word-best-accuracy.hdf5", monitor='accuracy', verbose=1, save_best_only=True, mode='max')
model.fit(X, y, batch_size=64, epochs=200, validation_split=0.05, callbacks=[checkpoint], use_multiprocessing=True, workers=16)
model.save('model-word.h5')